 ...
 */
@TeleOp(name = "Better Odo Calibration", group = "Calibrator")
public class BetterOdoCal extends LinearOpMode {
	...
	String verticalEncoderName = "intake", horizontalEncoderName = "back odo";
	
	final double PIVOT_SPEED = 0.5;
	
	//The amount of encoder ticks for each inch the robot moves. THIS WILL CHANGE FOR EACH ROBOT AND NEEDS TO BE UPDATED HERE
	final double COUNTS_PER_INCH = 8192 / (2.0 * 1.0 * Math.PI);
	...
	public void runOpMode () throws InterruptedException {
		...
		initHardwareMap(rfName, rbName, lfName, lbName, verticalEncoderName, horizontalEncoderName);
       ...
       */
		double encoderDifference = Math.abs(vertical.getCurrentPosition());
	...
	private void initHardwareMap (String rfName, String rbName, String lfName, String lbName, String vlEncoderName, String hEncoderName) {
		...
		vertical = hardwareMap.dcMotor.get(vlEncoderName);
